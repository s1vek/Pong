...
public class SingleplayerPanel extends JPanel implements Runnable { // Single player mode logic
    ...
    public SingleplayerPanel() { // Constructor where are in-game objects created and set their values

        ball = new Ball();
        player1 = new Racket(30, Values.RACKET_HEIGHT / 2, Values.RACKET_WIDTH, Values.RACKET_HEIGHT,1);
        player2 = new AI(Values.GAME_WIDTH - 40, Values.RACKET_HEIGHT / 2, Values.RACKET_WIDTH, Values.RACKET_HEIGHT,ball);
        score = new Score();
    ...
    private void setupPanel() {
        ...
        this.addKeyListener(new ControlsSingleplayer(this));
    ...
    private void ballRacketCollisions() {
        ...
        if (ball.cords().intersects(player1.cords())) { // If ball coordinates intersects coordinates racket of player 1, then X coordinates is going to change and also ball is going to move faster to make it more fun
        ...
        if (ball.cords().intersects(player2.cords())) { // If ball coordinates intersects coordinates racket of player 2 (AI), then X coordinates is going to change and also ball is going to move faster to make it more fun
